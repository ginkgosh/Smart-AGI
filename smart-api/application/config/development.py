...
SQLALCHEMY_DATABASE_URL = f"mysql+asyncmy://kinit:kinit123456@{IP_ADDRESS}:3306/kinit"
...
REDIS_DB_URL = f"redis://:redis123@{IP_ADDRESS}:6379/1"
...
MONGO_DB_NAME = "admin"
MONGO_DB_URL = f"mongodb://mongo_kinit:mongo_kinit123@{IP_ADDRESS}:27017/?authSource={MONGO_DB_NAME}"
